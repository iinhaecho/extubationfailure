# -*- coding: utf-8 -*-
"""ventilator_scoring.ipynb

Automatically generated by Colab.

Original file is located at
    https://colab.research.google.com/drive/1T6FZl66kijbUDb3sWpqkqSRYgMIodKCl
"""
...
def update_ventilator_scoring(df):
    ...
    for mode, hamilton in pairs:
        df.loc[(df['ventilator_mode'] == mode) & (df['ventilator_mode_hamilton'] == hamilton), 'ventilator_scoring'] = None

    # 해당되지 않는 mode이거나 NaN는 5로 맵핑
    df.loc[df.ventilator_scoring.isna(),'ventilator_scoring'] = 5
